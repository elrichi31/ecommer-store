...
const PLACEHOLDER_IMAGE = "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=800&q=80"
...
export default async function ShopByCategory({
  ...
  const categories = allCategories.filter((c) => !c.parent_category)
    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="content-container">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {categories.slice(0, 4).map((category: ExtendedCategory) => (
            <Link
              key={category.id}
